...
int64 nChainStartTime = 1471267130;
...
const string strMessageMagic = "SolarEnergyCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SolarEnergyCoin
    bool fStrictPayToScriptHash = true; // Always active in SolarEnergyCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SolarEnergyCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2016.8.15 SolarEnergyCoin";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("6856936970703c55902eba74a1e7ec56b210ee6b08b8bf8d29b18451f17458f0"));
