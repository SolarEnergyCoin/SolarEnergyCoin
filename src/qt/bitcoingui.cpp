...
{
    resize(850, 550);
    setWindowTitle(tr("SolarEnergyCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SolarEnergyCoin address"));
...
//    connect(chatAction , SIGNAL(triggered()), this, SLOT(gotoOverviewPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About SolarEnergyCoin"), this);
    aboutAction->setToolTip(tr("Show information about SolarEnergyCoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for SolarEnergyCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("SolarEnergyCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SolarEnergyCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SolarEnergyCoin network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SolarEnergyCoin address or malformed URI parameters."));
    }
